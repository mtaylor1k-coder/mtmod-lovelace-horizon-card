...
describe('HorizonCard', () => {
  ...
  describe('i18n', () => {
    ...
    it('uses the explicit config time zone over the local browser time zone', () => {
      ...
      expect(I18N).toHaveBeenCalledWith('es', 'Europe/Sofia', TimeFormat.language, NumberFormat.language)
    })
    ...
    it('uses the explicit config time zone over the server time zone', () => {
      ...
      horizonCard['i18n'](config)
      expect(I18N).toHaveBeenCalledWith('es', 'Asia/Tokyo', TimeFormat.language, NumberFormat.language)
    })
    ...
    it('uses the local browser time zone when config has no time zone', () => {
      ...
      horizonCard['i18n'](config)
      expect(I18N).toHaveBeenCalledWith('es', 'UTC', TimeFormat.language, NumberFormat.language)
    })
